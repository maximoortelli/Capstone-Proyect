...
Final project for Microverse Module #1. This project follows established guidelines and is built to commercial specifications. The aim of this project is to demonstrate my technical and soft skills acquired during this module.
...
``` $ git clone https://github.com/maximoortelli/Capstone-Proyect.git ```
