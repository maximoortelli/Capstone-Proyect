...
let alvar = new personsConstructor(
  'images/i1.svg',
  'Yochai Alvar',
...
let chon = new personsConstructor(
  'images/i2.svg',
  'Kilnam Chon',
...
let julia = new personsConstructor(
  'images/i3.svg',
  'Julia Leda',
...
let lila = new personsConstructor(
  'images/i4.svg',
  'Lila Tretikov',
...
let ryan = new personsConstructor(
  'images/i5.svg',
  'Ryan Merkley',
...
let noh = new personsConstructor(
  'images/i6.svg',
  'SohYeong Noh',
...
let persons = [alvar, chon, julia, lila, ryan, noh];
...
let gridPerson = document.getElementById('person');
